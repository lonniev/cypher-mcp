/**
 * Cloudflare Pages Function — proxy /mcp to cypher-mcp.fastmcp.app/mcp.
 *
 ...
 * and OPTIONS (CORS preflight). Mirrors taxsort/optionality/excalibur verbatim
 * with the upstream host swapped.
 */

const UPSTREAM = "https://cypher-mcp.fastmcp.app/mcp";
...
export async function onRequest(context) {
  ...
  upHeaders.set("Host", "cypher-mcp.fastmcp.app");

...
const SEVERITY_CLASS: Record<Exclude<Severity, "ok">, { row: string; label: string; text: string }> = {
  failure: { row: "-mx-1 rounded bg-red-950/60 px-1", label: "font-bold text-red-400", text: "text-red-300" },
  notice: { row: "-mx-1 rounded bg-purple-950/60 px-1", label: "text-purple-300", text: "text-purple-200" },
};
